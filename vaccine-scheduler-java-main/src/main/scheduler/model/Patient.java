...
public class Patient {
    ...
    public void uploadPatientAvailability(Date d) throws SQLException {
        ConnectionManager cm = new ConnectionManager();
        Connection con = cm.createConnection();

        String addPatientAvailability = "INSERT INTO PatientAvailabilities VALUES (? , ?)";
        try {
            PreparedStatement statement = con.prepareStatement(addPatientAvailability);
